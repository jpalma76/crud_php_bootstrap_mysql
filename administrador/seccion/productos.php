            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <?php if($txtImagen!="") { ?>
                        ...
                        <img class="img-thumbnail rounded" src="../../img/<?php echo $txtImagen; ?>" width="50px" justify-content="center" srcset="">
            ...
            <?php foreach($listaLibros as $libro) { ?>
                <tr>
                    ...
                    <td style="text-align: center">
                        <img class="img-thumbnail rounded" src="../../img/<?php echo $libro['imagen']; ?>" width="50px" srcset="">
                    </td>
